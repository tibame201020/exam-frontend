...
const History = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-slate-200">
                ...
                <div className="relative w-full md:w-80 group">
                    <input
                        ...
                        className="pro-input w-full pl-10 h-10 text-sm rounded-xl"
                        value={searchTerm}
                    ...
                    <table className="pro-table">
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={6} className="text-center py-20 opacity-30 italic text-base-content/40 text-sm">
                                    ...
                                    <tr key={record.id} className="hover:bg-base-200 transition-colors group">
                                        ...
                                        <td>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="font-bold text-base-content/80 text-sm">{record.examName}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="text-center">
                                            <div className="flex flex-col items-center gap-1">
                                                ...
                                                <div className="w-16 bg-base-200 h-1 rounded-full overflow-hidden">
                                                    <div className="bg-primary h-full" style={{ width: `${(record.correctNums / record.quizNums) * 100}%` }}></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div className="flex items-center gap-2 text-[10px] font-medium text-base-content/50">
                                        ...
                                        <td className="text-right">
                                            <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button
                                                    ...
                                                    className="btn btn-ghost btn-xs h-8 px-3 rounded-lg bg-primary/10 border border-primary/20 text-primary hover:bg-primary/20 gap-2 normal-case font-bold"
                                                >
                                                    Report <ArrowRight size={12} />
                                                </button>
                                                <button
                                                    onClick={() => handleDelete(record.id)}
                                                    className="btn btn-ghost btn-xs btn-square h-8 rounded-lg hover:bg-error/10 hover:text-error text-base-content/20"
                                                >
                                                    <Trash2 size={14} />
                                                </button>
                                            </div>
            ...
            <div className="flex items-center gap-4 bg-neutral text-neutral-content rounded-2xl p-5 shadow-lg overflow-hidden relative">
                ...
                <div>
                    <h3 className="font-bold text-sm">Intelligence Insight</h3>
                    <p className="text-[10px] opacity-60 font-medium">Your historical data is analyzed to provide personalized learning recommendations.</p>
                </div>
            </div>
        </div>
    );
